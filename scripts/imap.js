...
function createImapConfig() {
  return {
    ...
    connTimeout: 15000,
    authTimeout: 15000,
    // Force xoauth2 to bypass capability-based auth selection.
    // 163.com (and some Chinese mail servers) only advertise AUTH=XOAUTH2
    // in CAPABILITY, which prevents the library from trying LOGIN.
    // Setting xoauth2: '' makes the library attempt LOGIN anyway.
    xoauth2: '',
  };
}
